...
export function ParentLayoutShell({ children }: { children: React.ReactNode }) {
            ...
            <main className="flex-1 flex flex-col min-h-screen relative overflow-hidden">
                <header className="h-20 border-b border-slate-200 bg-white sticky top-0 z-30 flex items-center justify-between px-6 md:px-10">
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        <Button size="icon" variant="ghost" className="rounded-full text-slate-400 hover:text-slate-600 relative" aria-label="Notifications">
