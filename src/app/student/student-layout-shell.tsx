                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        {students.length > 1 && (
                            <div className="hidden md:flex items-center">
                                <label htmlFor="student-selector" className="sr-only">Select student</label>
                                <select
                                    id="student-selector"
                        ...
                        <Link href="/student/profile">
                            <Button size="icon" variant="ghost" className="rounded-full text-slate-400 hover:text-slate-600" aria-label="Student settings">
